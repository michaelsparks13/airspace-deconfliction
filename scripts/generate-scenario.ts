// Generates src/data/mock-san-juans-fire.json: 90-second replay, six
...
//
// Engineered events:
//   - N458DK (stray VFR GA single) is a NON-PARTICIPANT cruising north
//     through the TFR, threading directly over the fire and convective
//     column. Triggers a persistent intruder caution while inside the
//     cylinder and a column-incursion critical when overhead the column.
...
// Sheriff UAS holding ~400 ft AGL inside the SW lobe of the fire perimeter,
// helping spot for structure protection near Ophir. FTA participant, checked
// in to the ATGS, sitting in the UAS block.
...
const TRACKS: TrackManifest[] = [
	...
	{ id: 'uas-sheriff-1',   callsign: 'Eagle 1',       category: 'uas-sheriff',   crew: 'uas',    participant: true,  keys: UAS_KEYS },
	{ id: 'ga-intruder-1',   callsign: 'N458DK',        category: 'ga-fixed-wing', crew: 'manned', participant: false, keys: GA_INTRUDER_KEYS },
];
...
const file: ReplayFile = {
	...
	notes:
		...
		'events: N458DK transits the TFR northbound and overflies the fire / ' +
		'convective column; Tanker 21 block-busts on its retardant run and ' +
		'converges with 5H at T+42..T+50.',
